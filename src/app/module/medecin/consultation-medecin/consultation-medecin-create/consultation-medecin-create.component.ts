...
@Component({
    selector: 'app-consultation-medecin-create',
    templateUrl: './consultation-medecin-create.component.html',
    styleUrls: ['./consultation-medecin-create.component.scss']
})
export class ConsultationMedecinCreateComponent implements OnInit {
