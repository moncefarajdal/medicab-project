...
@Component({
  selector: 'app-consultation-medecin-view',
  templateUrl: './consultation-medecin-view.component.html',
  styleUrls: ['./consultation-medecin-view.component.scss']
})
export class ConsultationMedecinViewComponent implements OnInit {
