...
@Component({
  selector: 'app-type-consultation-medecin-create',
  templateUrl: './type-consultation-medecin-create.component.html',
  styleUrls: ['./type-consultation-medecin-create.component.scss']
})
export class TypeConsultationMedecinCreateComponent implements OnInit {
