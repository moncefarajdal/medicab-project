...
@Component({
  selector: 'app-type-consultation-medecin-list',
  templateUrl: './type-consultation-medecin-list.component.html',
  styleUrls: ['./type-consultation-medecin-list.component.scss']
})
export class TypeConsultationMedecinListComponent implements OnInit {
